...
#
"""
URL validation — blocks SSRF attempts, IDN/homograph attacks, private IPs, metadata endpoints, DNS rebinding.
...
# Blocked hostname patterns (metadata endpoints, suspicious domains)
